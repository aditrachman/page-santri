...
export default function Banner() {
    return (
        <div className="mt-5 mx-3 rounded-lg bg-white px-4 py-8 border-2 shaadow border-gray-200 sm:px-6">
            <div className="-ml-4 -mt-2 flex items-center justify-between flex-wrap sm:flex-nowrap">
                <div className="ml-4 mt-2">
                    <h3 className="pb-8 text-lg leading-6 font-medium text-gray-900">Event</h3>
                </div>
                <div className="ml-4 mt-2 flex-shrink-0">
                    {/* bisa nambah button dll */}
                </div>
            </div>
